...
#define LCD_RS P2_2
#define LCD_RW P2_1 // Not used in this code, should be connected to 0
#define LCD_E  P2_0
#define LCD_D4 P1_3
#define LCD_D5 P1_2
#define LCD_D6 P1_1
...
char _c51_external_startup (void)		// question: where's this function called? Why set the return type as char?
{
	...
	// this part initializes serial port
